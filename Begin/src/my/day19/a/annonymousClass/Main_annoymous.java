...
public class Main_annoymous {
	...
	public static void main(String[] args) {
		...
		double area_size1 = area1.area(10.5, 5.5);
		System.out.println("가로 10.5, 세로 5.5인 면적은 : "+area_size1);
		...
		double area_size2 = area2.area(20.5,15.5);
		System.out.println("가로 20.5 세로 15.5인 면적은 : "+area_size2);
		...
		InterArea area_obj = new InterArea() {
			@Override
		...
		double area_size3 = area_obj.area(10.5, 5.5);
		System.out.println("밑변 10.5, 높이 5.5인 삼각형의 면적은 : " + area_size3);
		//밑변 10.5, 높이 5.5인 삼각형의 면적은 : 28.875
